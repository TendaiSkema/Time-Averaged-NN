...
class Neuron:
    def __init__(self, input_size, self_size, threshold=0.7, value=1, learning_rate=0.1):
        self.lr = learning_rate
        self.input_size = input_size
        self.self_size = self_size
        self.threshold = threshold
        self.value = value
        self.weights = np.random.uniform(-1, 1, input_size+self_size)  # Initialize weights uniformly in [-1, 1]
...
class Layer:
    def __init__(self, input_size, output_size, threshold=0.7, value=1):
        self.neurons = [Neuron(input_size, output_size, threshold, value) for _ in range(output_size)]
        self.input_size = input_size
    ...
    def forward(self, x):
        ...
        combined_input = np.hstack((x, self.last_activation))  # Combine input with last activation
